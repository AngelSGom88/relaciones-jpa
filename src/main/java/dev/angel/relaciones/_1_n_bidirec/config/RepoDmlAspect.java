...
/**
 * Log de operaciones DML en repos del módulo 1-N BI.
...
public class RepoDmlAspect {
    ...
    @AfterReturning(
            "execution(* dev.angel.relaciones._1_n_bidirec..repository..*.save*(..)) || " +
                    ...
                    "execution(* dev.angel.relaciones._1_n_bidirec..repository..*.deleteAll*(..)) || " +
                    "execution(* dev.angel.relaciones._1_n_bidirec..repository..*.flush(..))"
    )
